...
def run_embedding(
    ...
    embedding.W.data = weights.clone()
...
def run_swiglu(
    ...
    swiglu.w1.data = w1_weight.clone()
    swiglu.w2.data = w2_weight.clone()
    swiglu.w3.data = w3_weight.clone()
...
def run_rmsnorm(
    ...
    rmsnorm.weight.data = weights.clone()
